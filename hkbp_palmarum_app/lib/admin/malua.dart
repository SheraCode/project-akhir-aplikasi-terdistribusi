...
class malua extends StatelessWidget {
  var height, width;
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10,),
                            Text("Request Surat Malua Jemaat",
                              style: TextStyle(
                                  fontSize: 16,
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "Request Surat Malua Jemaat ${titles[index]}",
                                          style: TextStyle(
                                            fontSize: 14,
                                          ),
                                        ),
                                          ...
                                          child: Padding(
                                            ...
                                            child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(
                                                  context,
                                                  MaterialPageRoute(builder: (context) => KelolaMalua()),
                                                );
