...
import 'package:hkbp_palmarum_app/admin/EditJadwalIbadah.dart';
...
class JadwalIbadah extends StatefulWidget {
  @override
  _WartaJemaatState createState() => _WartaJemaatState();
}

class _WartaJemaatState extends State<JadwalIbadah> {
  var height, width;
  List<dynamic> data = [];
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 10),
                          Text(
                            "Jadwal Ibadah HKBP Palmarum Tarutung",
                            style: TextStyle(
                              fontSize: 16,
                ...
                child: Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                        onTap: () {
                          navigateToEditJadwalIbadah(data[index]['id_jadwal_ibadah'].toString());
                        },
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'Jadwal Ibadah Tanggal ${data[index]['tgl_ibadah']}',
                                        style: TextStyle(
                                          fontSize: 18,
  ...
  void navigateToEditJadwalIbadah(String idJadwalIbadah) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => EditJadwalIbadah(idJadwalIbadah),
      ),
    );
  }
