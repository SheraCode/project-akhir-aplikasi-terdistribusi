...
class _TambahPemasukanState extends State<TambahPemasukan> {
  ...
  Future<void> _createPemasukan() async {
    try {
      final apiUrl = 'http://192.168.21.80:2008/pemasukan/create';

      // Prepare the request
      final request = http.MultipartRequest('POST', Uri.parse(apiUrl));

      // Add text fields
      request.fields['total_pemasukan'] = totalPemasukanController.text;
      request.fields['bentuk_pemasukan'] = bentukPemasukanController.text;
      ...
      if (response.statusCode == 200) {
        ...
        var snackBar = SnackBar(
          ...
          content: AwesomeSnackbarContent(
            title: "Success",
            message: "Pemasukan Berhasil di Tambahkan",
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10),
                            Text(
                              "Tambah Pemasukan HKBP Palmarum",
                              style: TextStyle(
                                fontSize: 16,
