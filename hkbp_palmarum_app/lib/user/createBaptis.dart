...
class createBaptis extends StatefulWidget {
  @override
  _createBaptisState createState() => _createBaptisState();
}

class _createBaptisState extends State<createBaptis> {
  var height, width;
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => ConfirmBaptis()),
                              );
                            },
                            child: Container(
